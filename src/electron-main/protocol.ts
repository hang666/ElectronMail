...
import {PROTON_API_URL_PLACEHOLDER, PROTON_SUPPRESS_UPSELL_MESSAGES_PLACEHOLDER} from "src/shared/const/proton-url";
    ...
    return Readable.from(
        Buffer.from(
            (await fsAsync.readFile(fileLocation)).toString()
                ...
                .replaceAll(PROTON_SUPPRESS_UPSELL_MESSAGES_PLACEHOLDER, String(suppressUpsellMessages)),
        ),
    );
};
